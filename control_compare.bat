...
:: 运行 para1
echo [Task 1] Running with para file...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60_ang_high.txt
echo Task 1 Finished.
echo.

:: 运行 para2 (假设你已经创建了)
echo [Task 2] Running with para2.txt...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60_ang_highhigh.txt
echo Task 2 Finished.
echo.

:: 运行 para2 (假设你已经创建了)
echo [Task 2] Running with para2.txt...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60_ang_low.txt
echo Task 2 Finished.
echo.

:: 运行 para2 (假设你已经创建了)
echo [Task 2] Running with para2.txt...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60_ang_lowlow.txt
echo Task 2 Finished.
echo.
...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60+a-d.txt
echo Task 6 Finished.
echo.

echo [Task 6] Running with para6.txt...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60+d-a.txt
echo Task 6 Finished.
echo.

echo [Task 6] Running with para6.txt...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\namaqualand_128_60+d-ll.txt
echo Task 6 Finished.
echo.

echo [Task 6] Running with para6.txt...
%EXE_PATH% D:\VSprojects\TaihuStone\para\comp\nnamaqualand_128_60+ll-a.txt
echo Task 6 Finished.
echo.
